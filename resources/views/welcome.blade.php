            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li>
							<a href="#"><span class="menu-side"><img src="assets/img/icons/menu-icon-06.svg" alt=""></span> <span> Seksi / Bidang </span></a>
						</li>
                        <li class="submenu">
                        ...
                        <li>
							<a href="#"><span class="menu-side"><img src="assets/img/icons/menu-icon-02.svg" alt=""></span> <span> Pengajar </span></a>
						</li>
                        <li>
							<a href="#"><span class="menu-side"><img src="assets/img/icons/menu-icon-03.svg" alt=""></span> <span> Peserta </span></a>
						</li>
                        <li>
							<a href="#"><span class="menu-side"><img src="assets/img/icons/menu-icon-04.svg" alt=""></span> <span> Kegiatan Pelatihan </span></a>
						</li>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="morning-user">
								<h2>Selamat Datang, <span>Daniel Bruk</span></h2>
